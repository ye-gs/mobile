...
export const IconSelectionModal: React.FC<IconSelectionModalProps> = ({ visible, onClose, onSelectIcon }) => {
  const renderIconItem = ({ item }: { item: FontAwesomeIconNames }) => (
    ...
    >
      ...
      <Text style={styles.iconText}>{item}</Text> {/* Exibe o nome do ícone */}
    </TouchableOpacity>
  );
